  ...
  return (
    <>
      ...
      <div className="space-y-12">
        ...
        <section className="grid gap-6 md:grid-cols-2">
          ...
          <Card className="group hover:scale-105 transition-all duration-200">
            ...
            <div className="flex items-center justify-center">
              <div className="h-40 w-40 rounded-full bg-primary/20 p-8">
                <ArrowDownUp className="h-full w-full text-primary" />
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Stats Grid */}
        <section>
          <h2 className="mb-6 text-2xl font-semibold tracking-tight">Market Overview</h2>
              ...
              <Card key={stat.title}>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`rounded-full p-3 ${stat.positive ? 'bg-success/10' : 'bg-destructive/10'}`}>
                      <stat.icon className={`h-6 w-6 ${stat.positive ? 'text-success' : 'text-destructive'}`} />
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Latest market prices for top pairs</CardDescription>
                </div>
                <Input className="w-[180px]" placeholder="Search token pairs..." />
              </div>
            </CardHeader>
            <CardContent>
              ...
              {tokenPairs.map((pair) => (
                <div key={pair.name}>
                  <div className="grid grid-cols-5 items-center gap-4 py-3">
                    ...
                    <div>{pair.price}</div>
                    <div className={pair.positive ? 'text-success' : 'text-destructive'}>
                      {pair.change}
                    </div>
                    <div>{pair.volume}</div>
                    <div>
        ...
        <section className="grid gap-6 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Recent protocol developments</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <Badge>New</Badge>
                  <h4 className="font-medium">Perpetual Trading Launched</h4>
                </div>
                <p className="text-sm text-muted-foreground">
                  We've launched our perpetual trading feature with up to 50x leverage.
                </p>
              </div>
              <Separator />
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-medium">Gas Optimization Update</h4>
                </div>
                <p className="text-sm text-muted-foreground">
                  Our latest protocol update reduces gas costs by an average of 15%.
                </p>
              </div>
              <Separator />
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-medium">Governance Proposal #23</h4>
                </div>
                <p className="text-sm text-muted-foreground">
                  Vote on the latest proposal to add new liquidity incentives.
                </p>
              </div>
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Get started with NovaDex</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="rounded-md bg-accent p-4">
                <h4 className="font-medium">Connect Your Wallet</h4>
                <p className="mt-1 text-sm text-muted-foreground">
                  Start by connecting your wallet to access all features.
                </p>
              ...
              <div className="rounded-md bg-accent p-4">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Provide liquidity to earn passive income on your assets.
                </p>
